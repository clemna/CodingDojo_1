...
namespace CodingDojo1
{
    class Program
    {
        static void Main(string[] args)
            ...
            {
                Stack<TestObj> test = new Stack<TestObj>();

                test.Push(new TestObj(41, "Sampleperson1"));
                Console.WriteLine("read: {0}", test.Peek());
                test.Push(new TestObj(80, "Sampleperson2"));
                Console.WriteLine("read: {0}", test.Peek());
                test.Push(new TestObj(15, "Sampleperson3"));
                Console.WriteLine("read: {0}", test.Peek());
                Console.WriteLine("{0} removed", test.Pop());
                Console.WriteLine("read: {0}", test.Peek());
                Console.WriteLine("{0} removed", test.Pop());
